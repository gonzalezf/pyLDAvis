...
var {{ visid_raw }}_tweets = {{ tweets_json }};
...
def prepared_data_to_html(data, tweets, d3_url=None, ldavis_url=None, ldavis_css_url=None, ldavis_tweet_css_url=None,
    ...
    tweets : Tweets after topic modelling on JSON format
...
def display(data, tweets, local=False, **kwargs):
    ...
    **kwargs :
    ...
    return HTML(prepared_data_to_html(data, tweets, **kwargs))


def show(data, tweets, ip='127.0.0.1', port=8888, n_retries=50,
    ...
    **kwargs :
    ...
    html = prepared_data_to_html(data, tweets, **kwargs)
...
def save_html(data, tweets, fileobj, **kwargs):
    ...
    **kwargs :
    ...
    fileobj.write(prepared_data_to_html(data, tweets, **kwargs))
